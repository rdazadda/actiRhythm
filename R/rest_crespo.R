...
#'
#' @references
#' Crespo C, Aboy M, Fernandez JR, Mojon A (2012). Automatic identification of
#' activity-rest periods based on actigraphy. \emph{Medical & Biological
#' Engineering & Computing}, 50(4):329-340. \doi{10.1007/s11517-012-0875-y}
#'

...
**actiRhythm measures circadian rest-activity rhythms from activity counts.** It
needs only a count vector and its timestamps, and it reads those counts straight out
of an ActiGraph `.agd` file. From one recording it produces the metrics a

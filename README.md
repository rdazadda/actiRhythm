...
`vignette("actiRhythm")` walks through a full analysis, from reading a
file to exporting the results. Each function’s help page carries its
method reference, so `?circadian.rhythm`, `?cosinor.analysis`, and
